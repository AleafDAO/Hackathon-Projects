...
contract DonateMain is DonationT,DonationEvent,GovernImp{
    ...
    function creatDonationCampaign(address recipient,uint256 targetAmount,uint256 duration) public adminOnly(){
    ...
    function donate(uint donationCampaignId,uint amount) public payable{
        ...
        require(address(this).balance >= amount, "DonateMain::donate:Your ETH is not enough.");
        ...
        require(sent && feesent,"DonateMain::donate:Fallback.");
